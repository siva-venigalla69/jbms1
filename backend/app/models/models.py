from sqlalchemy import Column, Integer, String, Text, DateTime, Decimal, Boolean, ForeignKey, Enum
...
class GSTInvoice(Base):
    ...
    cgst_rate = Column(Decimal(5, 2), default=9.00)
    sgst_rate = Column(Decimal(5, 2), default=9.00)
